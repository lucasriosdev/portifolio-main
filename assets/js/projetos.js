    ...
    <div class="content">
      <div class="cards">
        ...
        <div class="card">
          ...
          <div class="img-wrapper">
            <img src="https://github.com/lucasriosdev/api-usuario/blob/main/image/api.png?raw=true" alt="Imagem do projeto." />
            <div class="buttons">
              <a href="https://github.com/lucasriosdev/api-usuario/blob/main/image/api.png" target="_blank" title="Repositório no Github">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
              ...
              <a href="https://github.com/lucasriosdev/api-usuario/blob/main/image/api.png" target="_blank" title="Ver Projeto">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
          ...
          <p>
           Esta é uma API simples de gerenciamento de usuários utilizando Express.js.
          </p>
          <p>Node.JS - JS - Express</p>
        </div>
        <div></div>
        <div class="card">
          <h3>Visite meu GitHub ou LinkdIn para conhecer mais!</h3>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            width="24"
